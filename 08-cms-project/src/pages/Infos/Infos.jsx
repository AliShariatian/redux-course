         ...
         <div className="content__wrapper">
            ...
            <div className="information">
               <div id="accordion">
                     ...
                     <div id="collapseOne" className="collapse show" data-bs-parent="#accordion">
                        <div className="card-body information-current-admin-wrapper-form p-4">
                           <form action="#" className="form row mx-0">
                              ...
                              <button className="btn-custome btn-custome__blue col-6 mb-3">اپدیت اطلاعات</button>
                           </form>
                        </div>
                     </div>
                  </div>
                  ...
                  <div className="card">
                     <div className="card-header">
                        <a className="collapsed btn information__team-title" data-bs-toggle="collapse" href="#collapseTwo">
                           اطلاعات تیم
                        </a>
                     </div>
                     <div id="collapseTwo" className="collapse" data-bs-parent="#accordion">
                        <div className="row justify-content-center mx-0 p-4">
                           <div className="infromation-team-container">
                              <div className="infromation-team-cards d-flex flex-wrap">
                                 <div className="card col-4 information__team-card p-2">
                                    <img className="card-img-top information__admin-img" src="../../img/store/avaters/avatar2.png" alt="admin photo" />
                                    <div className="card-body d-flex flex-column justify-content-between p-4">
                                       <div className="d-flex justify-content-between align-items-center mb-4">
                                          <h4 className="card-title information__admin-name my-0">عرشیا احسنی</h4>
                                          <p className="card-text information__admin-role my-0">باغدار</p>
                                       </div>
                           ...
                           <button className="btn-custome btn-custome__red col-10 mt-4" data-bs-toggle="modal" data-bs-target="#new-member">
                              افزودن فرد جدید
                           </button>
                        </div>
                     </div>
