      ...
      <div className="container px-0">
         <header className="header col-10 col-md-12 mx-auto">
            <div className="header__info">
               <img src="../../img/admin/profile/banana.png" alt="admin photo" className="header__img" />
               <div className="header__details">
                  <h4 className="header__name mb-2">علی شریعتیان</h4>
                  <p className="header__email my-0">
