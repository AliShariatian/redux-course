      ...
      <div className="col-10 col-md-3 sidebar mx-auto mx-md-0 px-0">
         <div className="sidebar-content">
            <div className="card position-relative text-center">
               <img className="card-img-top sidebar__img-banner" src="../../img/admin/banner/banner.png" alt="banner admin photo" />
               <div className="card-body">
                  <h4 className="card-title sidebar__top-name">علی شریعتیان</h4>
                  <p className="card-text sidebar__top-email">
                  ...
                  <ul className="list px-0">
                     <li className="list__item">
                        ...
                        <p className="list__text mb-0">
                           ...
                           <span className="list__firstname">علی</span>
                        </p>
                     </li>
                     <li className="list__item">
                        ...
                        <p className="list__text mb-0">
                           ...
                           <span className="list__lastname">شریعتیان</span>
                        </p>
                     </li>
                     <li className="list__item">
               ...
               <div className="sidebar__profile">
                  <img src="../../img/admin/profile/banana.png" alt="admin photo" className="sidebar__img-profile" />
               </div>
            </div>
         </div>
      </div>
